...
from .types.create_evaluator_log_request_spec import CreateEvaluatorLogRequestSpec
...
class EvaluatorsClient:
    ...
    def upsert(
        ...
        *,
        ...
        Examples
        --------
        from humanloop import CodeEvaluatorRequest, Humanloop
    ...
    def log(
        ...
        *,
        ...
        spec: typing.Optional[CreateEvaluatorLogRequestSpec] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        spec : typing.Optional[CreateEvaluatorLogRequestSpec]
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateEvaluatorLogResponse, construct_type(type_=CreateEvaluatorLogResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 422:
                raise UnprocessableEntityError(
                    typing.cast(HttpValidationError, construct_type(type_=HttpValidationError, object_=_response.json()))  # type: ignore
                )
...
class AsyncEvaluatorsClient:
    ...
    async def upsert(
        ...
        *,
        ...
        from humanloop import AsyncHumanloop, CodeEvaluatorRequest

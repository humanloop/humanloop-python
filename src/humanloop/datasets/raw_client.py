...
class RawDatasetsClient:
    ...
    ) -> HttpResponse[SyncPager[DatasetResponse]]:
        """
        List all Datasets.
    ...
    def list_datapoints(
        ...
        *,
        ...
        size: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[SyncPager[DatapointResponse]]:
        """
...
class AsyncRawDatasetsClient:
    ...
    async def list(
        ...
        *,
        ...
        order: typing.Optional[SortOrder] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AsyncPager[DatasetResponse]]:
        """
        List all Datasets.
    ...
    async def list_datapoints(
        ...
        *,
        ...
        size: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AsyncPager[DatapointResponse]]:
        """
        List all Datapoints for the Dataset with the given ID.

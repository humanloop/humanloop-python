...
class ModelConfigResponse(UncheckedBaseModel):
    ...
    stop: typing.Optional[ModelConfigResponseStop] = pydantic_v1.Field(default=None)
    """
    ...
    chat_template: typing.Optional[typing.List[ChatMessageWithToolCall]] = pydantic_v1.Field(default=None)
    """
    ...
    tool_configs: typing.Optional[typing.List[ToolConfigResponse]] = pydantic_v1.Field(default=None)
    """
    NB: Deprecated with tools field. Definition of tools shown to the model.
    """

    tools: typing.Optional[typing.List[ConfigToolResponse]] = pydantic_v1.Field(default=None)
    """

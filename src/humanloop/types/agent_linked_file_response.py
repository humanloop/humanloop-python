...
update_forward_refs(AgentResponse, AgentLinkedFileResponse=AgentLinkedFileResponse)
update_forward_refs(EvaluatorResponse, AgentLinkedFileResponse=AgentLinkedFileResponse)
update_forward_refs(FlowResponse, AgentLinkedFileResponse=AgentLinkedFileResponse)
update_forward_refs(MonitoringEvaluatorResponse, AgentLinkedFileResponse=AgentLinkedFileResponse)
update_forward_refs(PromptResponse, AgentLinkedFileResponse=AgentLinkedFileResponse)
update_forward_refs(ToolResponse, AgentLinkedFileResponse=AgentLinkedFileResponse)
update_forward_refs(VersionDeploymentResponse, AgentLinkedFileResponse=AgentLinkedFileResponse)
update_forward_refs(VersionIdResponse, AgentLinkedFileResponse=AgentLinkedFileResponse)

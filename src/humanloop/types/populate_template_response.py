...
class PopulateTemplateResponse(UncheckedBaseModel):
    ...
    template: typing.Optional[PopulateTemplateResponseTemplate] = pydantic.Field(default=None)
    """
    ...
    stop: typing.Optional[PopulateTemplateResponseStop] = pydantic.Field(default=None)
    """
...
update_forward_refs(PromptResponse, PopulateTemplateResponse=PopulateTemplateResponse)
update_forward_refs(ToolResponse, PopulateTemplateResponse=PopulateTemplateResponse)
update_forward_refs(VersionDeploymentResponse, PopulateTemplateResponse=PopulateTemplateResponse)
update_forward_refs(VersionIdResponse, PopulateTemplateResponse=PopulateTemplateResponse)

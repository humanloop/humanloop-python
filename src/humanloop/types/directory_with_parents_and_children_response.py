...
update_forward_refs(
    AgentLinkedFileResponse, DirectoryWithParentsAndChildrenResponse=DirectoryWithParentsAndChildrenResponse
)
update_forward_refs(AgentResponse, DirectoryWithParentsAndChildrenResponse=DirectoryWithParentsAndChildrenResponse)

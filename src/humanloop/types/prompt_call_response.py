...
update_forward_refs(AgentLinkedFileResponse, PromptCallResponse=PromptCallResponse)
update_forward_refs(AgentResponse, PromptCallResponse=PromptCallResponse)

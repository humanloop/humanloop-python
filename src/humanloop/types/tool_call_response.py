...
update_forward_refs(AgentLinkedFileResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(AgentResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(EvaluatorResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(FlowResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(MonitoringEvaluatorResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(PromptResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(ToolResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(VersionDeploymentResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(VersionIdResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(AgentLogResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(EvaluatorLogResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(FlowLogResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(PromptLogResponse, ToolCallResponse=ToolCallResponse)
update_forward_refs(ToolLogResponse, ToolCallResponse=ToolCallResponse)

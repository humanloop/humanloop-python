...
class ModelConfigRequest(UncheckedBaseModel):
    ...
    stop: typing.Optional[ModelConfigRequestStop] = pydantic_v1.Field(default=None)
    """
    ...
    tools: typing.Optional[typing.List[ModelConfigRequestToolsItem]] = pydantic_v1.Field(default=None)
    """

...
class AgentConfigResponse(UncheckedBaseModel):
    ...
    agent_class: str = pydantic_v1.Field()
    """
    Class of the agent.
    """

    tools: typing.Optional[typing.List[ToolConfigRequest]] = pydantic_v1.Field(default=None)
    """
    Tools associated with the agent.
    """

    model_config: ModelConfigRequest = pydantic_v1.Field()
    """

...
update_forward_refs(AgentLinkedFileResponse, AgentResponse=AgentResponse)
update_forward_refs(EvaluatorResponse, AgentResponse=AgentResponse)
update_forward_refs(FlowResponse, AgentResponse=AgentResponse)
update_forward_refs(MonitoringEvaluatorResponse, AgentResponse=AgentResponse)
update_forward_refs(PromptResponse, AgentResponse=AgentResponse)
update_forward_refs(ToolResponse, AgentResponse=AgentResponse)
update_forward_refs(VersionDeploymentResponse, AgentResponse=AgentResponse)
update_forward_refs(VersionIdResponse, AgentResponse=AgentResponse)

...
update_forward_refs(AgentLinkedFileResponse, EvaluationResponse=EvaluationResponse)
update_forward_refs(AgentResponse, EvaluationResponse=EvaluationResponse)

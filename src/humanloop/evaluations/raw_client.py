...
class RawEvaluationsClient:
    ...
    ) -> HttpResponse[SyncPager[EvaluationResponse]]:
        """
    ...
    def create(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[EvaluationResponse]:
        """
    ...
    def get_logs(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[PaginatedDataEvaluationLogResponse]:
        """
...
class AsyncRawEvaluationsClient:
    ...
    async def list(
        ...
        *,
        ...
        size: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AsyncPager[EvaluationResponse]]:
        """
        Retrieve a list of Evaluations for the specified File.
    ...
    async def create(
        ...
        *,
        ...
        name: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[EvaluationResponse]:
        """
        Create an Evaluation.
    ...
    async def get_stats(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[EvaluationStats]:
        """
        Get Evaluation Stats.
    ...
    async def get_logs(
        ...
        *,
        ...
        run_id: typing.Optional[typing.Union[str, typing.Sequence[str]]] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[PaginatedDataEvaluationLogResponse]:
        """
        Get the Logs associated to a specific Evaluation.

...
from ..types.paginated_data_union_prompt_response_tool_response_dataset_response_evaluator_response import (
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(
                    PaginatedDataUnionPromptResponseToolResponseDatasetResponseEvaluatorResponse,
                    construct_type(
                        type_=PaginatedDataUnionPromptResponseToolResponseDatasetResponseEvaluatorResponse,  # type: ignore

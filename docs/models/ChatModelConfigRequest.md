# humanloop.model.chat_model_config_request.ChatModelConfigRequest
...
------------ | ------------- | ------------- | ------------- | -------------
**model_config_id** | str,  | str,  | Identifies the model configuration used to create a chat response. | 

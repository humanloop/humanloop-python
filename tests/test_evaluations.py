...
async def test_delete(client: Humanloop, async_client: AsyncHumanloop) -> None:
    ...
    assert (
        client.evaluations.delete(id="ev_567yza")  # type: ignore[func-returns-value]
        is None
    )

    assert (
        await async_client.evaluations.delete(id="ev_567yza")  # type: ignore[func-returns-value]
        is None
    )
        ...
        "evaluators": [
            {
                "version": {
                    "path": "path",
                    "id": "id",
                    "spec": {"arguments_type": "target_free", "return_type": "boolean", "evaluator_type": "llm"},
                    "name": "name",
                    "version_id": "version_id",
                    "created_at": "2024-01-15T09:30:00Z",
                    "updated_at": "2024-01-15T09:30:00Z",
            ...
            "list",
            {
                0: {
                    "version": {
                        "path": None,
                        "id": None,
                        "spec": {"arguments_type": None, "return_type": None, "evaluator_type": None},
                        "name": None,
                        "version_id": None,
                        "created_at": "datetime",
                        "updated_at": "datetime",

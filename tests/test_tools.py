...
async def test_delete(client: Humanloop, async_client: AsyncHumanloop) -> None:
    ...
    assert (
        client.tools.delete(id="tl_789ghi")  # type: ignore[func-returns-value]
        is None
    )

    assert (
        await async_client.tools.delete(id="tl_789ghi")  # type: ignore[func-returns-value]
        is None
    )
...
async def test_remove_deployment(client: Humanloop, async_client: AsyncHumanloop) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert (
        client.tools.remove_deployment(id="tl_789ghi", environment_id="staging")  # type: ignore[func-returns-value]
        is None
    )

    assert (
        await async_client.tools.remove_deployment(id="tl_789ghi", environment_id="staging")  # type: ignore[func-returns-value]
        is None
    )

...
from humanloop.type.model_config_request_tools import ModelConfigRequestTools
...
class OptionalModelConfigRequest(TypedDict, total=False):
    ...
    tools: ModelConfigRequestTools

    type: str

class ModelConfigRequest(RequiredModelConfigRequest, OptionalModelConfigRequest):
    pass

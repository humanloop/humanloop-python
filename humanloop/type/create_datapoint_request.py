...
class OptionalCreateDatapointRequest(TypedDict, total=False):
    inputs: CreateDatapointRequestInputs

    # The chat messages for this datapoint.
    messages: typing.List[ChatMessageWithToolCall]

    target: CreateDatapointRequestTarget

class CreateDatapointRequest(RequiredCreateDatapointRequest, OptionalCreateDatapointRequest):
    pass

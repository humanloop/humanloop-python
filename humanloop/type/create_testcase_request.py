...
class RequiredCreateTestcaseRequest(TypedDict):
    pass

class OptionalCreateTestcaseRequest(TypedDict, total=False):
    inputs: CreateTestcaseRequestInputs

    # The chat messages for this testcase.
    messages: typing.List[ChatMessage]

    target: CreateTestcaseRequestTarget

class CreateTestcaseRequest(RequiredCreateTestcaseRequest, OptionalCreateTestcaseRequest):
    pass

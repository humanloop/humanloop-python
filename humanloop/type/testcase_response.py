...
class OptionalTestcaseResponse(TypedDict, total=False):
    inputs: TestcaseResponseInputs

    messages: typing.List[ChatMessage]

    target: TestcaseResponseTarget

    source_project_data_id: str

class TestcaseResponse(RequiredTestcaseResponse, OptionalTestcaseResponse):
    pass

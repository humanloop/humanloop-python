...
class OptionalPaginatedDataTestcaseResponse(TypedDict, total=False):
    pass

class PaginatedDataTestcaseResponse(RequiredPaginatedDataTestcaseResponse, OptionalPaginatedDataTestcaseResponse):
    pass

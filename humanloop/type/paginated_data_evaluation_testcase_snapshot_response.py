...
class OptionalPaginatedDataEvaluationTestcaseSnapshotResponse(TypedDict, total=False):
    pass

class PaginatedDataEvaluationTestcaseSnapshotResponse(RequiredPaginatedDataEvaluationTestcaseSnapshotResponse, OptionalPaginatedDataEvaluationTestcaseSnapshotResponse):
    pass

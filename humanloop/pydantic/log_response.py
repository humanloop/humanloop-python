...
class LogResponse(BaseModel):
    ...
    feedback: typing.List[FeedbackResponse] = Field(None, alias='feedback')
    ...
    model_config_: ProjectConfigResponse = Field(None, alias='model_config')

    # User email address provided when creating the datapoint.
    user: str = Field(None, alias='user')

    # Original response from the provider.
    provider_response: typing.Union[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]], str] = Field(None, alias='provider_response')

    # Latency of provider response.
    provider_latency: typing.Union[int, float] = Field(None, alias='provider_latency')

    # Raw output from the provider.
    raw_output: str = Field(None, alias='raw_output')

    # Reason the generation finished.
    finish_reason: str = Field(None, alias='finish_reason')

    metric_values: typing.List[MetricValueResponse] = Field(None, alias='metric_values')

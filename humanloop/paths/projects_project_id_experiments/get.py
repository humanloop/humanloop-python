...
from humanloop.pydantic.experiments_list_response import ExperimentsListResponse as ExperimentsListResponsePydantic
...
class List(BaseApi):
    ...
    async def alist(
        ...
        return api_client.construct_model_instance(ExperimentsListResponsePydantic, raw_response.body)

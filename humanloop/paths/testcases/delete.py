...
from humanloop.model.testsets_delete_testcase_request import TestsetsDeleteTestcaseRequest as TestsetsDeleteTestcaseRequestSchema
...
from humanloop.type.testsets_delete_testcase_request import TestsetsDeleteTestcaseRequest
...
# body param
SchemaForRequestBodyApplicationJson = TestsetsDeleteTestcaseRequestSchema


request_body_testsets_delete_testcase_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _delete_mapped_args(
        self,
        body: TestsetsDeleteTestcaseRequest,
    ...
    async def _adelete_oapg(
        ...
        serialized_data = request_body_testsets_delete_testcase_request.serialize(body, content_type)

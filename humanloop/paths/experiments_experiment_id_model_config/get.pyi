...
class SampleRaw(BaseApi):
    ...
    async def asample(
        ...
        args = self._sample_mapped_args(
            experiment_id=experiment_id,
        )
        return await self._asample_oapg(

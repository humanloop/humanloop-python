...
# body param
SchemaForRequestBodyApplicationJson = UpdateDatasetRequestSchema


request_body_update_dataset_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _aupdate_oapg(
        ...
        serialized_data = request_body_update_dataset_request.serialize(body, content_type)

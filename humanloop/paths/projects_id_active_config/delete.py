...
class BaseApi(api_client.Api):
    ...
    def _deactivate_config_mapped_args(
        self,
        id: str,
    ...
    async def _adeactivate_config_oapg(
        self,
...
class DeactivateConfigRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adeactivate_config(
        self,
        id: str,
        environment: typing.Optional[str] = None,
    ) -> typing.Union[
    ...
    def deactivate_config(
        ...
        return self._deactivate_config_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DeactivateConfig(BaseApi):
    ...
    def deactivate_config(
        ...
        raw_response = self.raw.deactivate_config(
            id=id,
            environment=environment,
        )
        if validate:

...
from humanloop.pydantic.projects_get_configs_response import ProjectsGetConfigsResponse as ProjectsGetConfigsResponsePydantic

from . import path

# Query params
EvaluationAggregatesSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'evaluation_aggregates': typing.Union[EvaluationAggregatesSchema, bool, ],
    },
    total=False
)
...
request_query_evaluation_aggregates = api_client.QueryParameter(
    name="evaluation_aggregates",
    style=api_client.ParameterStyle.FORM,
    schema=EvaluationAggregatesSchema,
    explode=True,
)
# Path params
...
class BaseApi(api_client.Api):
    ...
    def _list_configs_mapped_args(
        ...
        _query_params = {}
        _path_params = {}
        if evaluation_aggregates is not None:
            _query_params["evaluation_aggregates"] = evaluation_aggregates
        if id is not None:
            _path_params["id"] = id
    ...
    async def _alist_configs_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_evaluation_aggregates,
        ):
...
class ListConfigsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_configs(
        self,
        id: str,
        evaluation_aggregates: typing.Optional[bool] = None,
        **kwargs,
    ...
    def list_configs(
        ...
        return self._list_configs_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListConfigs(BaseApi):
    ...
    async def alist_configs(
        ...
        **kwargs,
        ...
        return api_client.construct_model_instance(ProjectsGetConfigsResponsePydantic, raw_response.body)

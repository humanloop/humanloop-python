...
# body param
SchemaForRequestBodyApplicationJson = CreateEvaluatorRequestSchema


request_body_create_evaluator_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = EvaluatorResponseSchema
...
class BaseApi(api_client.Api):
    ...
    async def _acreate_oapg(
        ...
        serialized_data = request_body_create_evaluator_request.serialize(body, content_type)

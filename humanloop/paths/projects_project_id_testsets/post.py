...
from humanloop.model.create_testset_request import CreateTestsetRequest as CreateTestsetRequestSchema
...
from humanloop.type.create_testset_request import CreateTestsetRequest
...
# body param
SchemaForRequestBodyApplicationJson = CreateTestsetRequestSchema


request_body_create_testset_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TestsetResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: TestsetResponse
...
class BaseApi(api_client.Api):
    ...
    async def _acreate_oapg(
        ...
        serialized_data = request_body_create_testset_request.serialize(body, content_type)

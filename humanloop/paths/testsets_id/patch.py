...
# body param
SchemaForRequestBodyApplicationJson = UpdateTestsetRequestSchema


request_body_update_testset_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TestsetResponseSchema
...
class BaseApi(api_client.Api):
    ...
    async def _aupdate_oapg(
        ...
        serialized_data = request_body_update_testset_request.serialize(body, content_type)

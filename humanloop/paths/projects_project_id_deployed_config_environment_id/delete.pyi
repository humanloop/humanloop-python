...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'environment_id': typing.Union[EnvironmentIdSchema, str, ],
    }
)
...
request_path_environment_id = api_client.PathParameter(
    name="environment_id",
    style=api_client.ParameterStyle.SIMPLE,
...
class BaseApi(api_client.Api):
    ...
    def _delete_deployed_config_mapped_args(
        self,
        project_id: str,
        environment_id: str,
    ...
    async def _adelete_deployed_config_oapg(
        self,
    ...
    def _delete_deployed_config_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteDeployedConfigRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_deployed_config(
        self,
        project_id: str,
        environment_id: str,
        **kwargs,
    ...
    def delete_deployed_config(
        ...
        return self._delete_deployed_config_oapg(
            path_params=args.path,
        )

class DeleteDeployedConfig(BaseApi):

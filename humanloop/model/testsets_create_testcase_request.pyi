...
class TestsetsCreateTestcaseRequest(
    ...
    class MetaOapg:
        ...
        class any_of_2(
            ...
            class MetaOapg:
                ...
                @staticmethod
                def items() -> typing.Type['CreateTestcaseRequest']:
                    return CreateTestcaseRequest
        
            def __new__(
                cls,
                arg: typing.Union[typing.Tuple['CreateTestcaseRequest'], typing.List['CreateTestcaseRequest']],
            ...
            def __getitem__(self, i: int) -> 'CreateTestcaseRequest':

...
class ProjectUserResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "email_address", "full_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "email_address", "full_name", ], str]):

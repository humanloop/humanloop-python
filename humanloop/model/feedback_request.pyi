...
class FeedbackRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "value", "data_id", "user", "created_at", "unset", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "value", "data_id", "user", "created_at", "unset", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        unset: typing.Union[MetaOapg.properties.unset, bool, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'FeedbackRequest':
        return super().__new__(

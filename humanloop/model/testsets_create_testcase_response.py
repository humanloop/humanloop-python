...
class TestsetsCreateTestcaseResponse(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TestcaseResponse']:
            return TestcaseResponse

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TestcaseResponse'], typing.List['TestcaseResponse']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'TestsetsCreateTestcaseResponse':

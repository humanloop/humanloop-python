...
class PaginatedDataEvaluationTestcaseSnapshotResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class records(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EvaluationTestcaseSnapshotResponse']:
                        return EvaluationTestcaseSnapshotResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['EvaluationTestcaseSnapshotResponse'], typing.List['EvaluationTestcaseSnapshotResponse']],
                ...
                def __getitem__(self, i: int) -> 'EvaluationTestcaseSnapshotResponse':

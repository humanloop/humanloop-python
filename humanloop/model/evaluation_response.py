...
class EvaluationResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def testset() -> typing.Type['TestsetResponse']:
                return TestsetResponse
        
            @staticmethod
            def testset_snapshot() -> typing.Type['TestsetResponse']:
                return TestsetResponse
            ...
            __annotations__ = {
                ...
                "testset": testset,
                "testset_snapshot": testset_snapshot,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["testset"]) -> 'TestsetResponse': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["testset_snapshot"]) -> 'TestsetResponse': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "status", "config", "created_at", "updated_at", "evaluators", "testset", "testset_snapshot", "evaluator_aggregates", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["testset"]) -> 'TestsetResponse': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["testset_snapshot"]) -> typing.Union['TestsetResponse', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "status", "config", "created_at", "updated_at", "evaluators", "testset", "testset_snapshot", "evaluator_aggregates", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        config: 'ConfigResponse',
        status: 'EvaluationStatus',
        testset_snapshot: typing.Union['TestsetResponse', schemas.Unset] = schemas.unset,

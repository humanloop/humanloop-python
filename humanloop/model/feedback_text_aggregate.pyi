...
class FeedbackTextAggregate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["feedback_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["feedback_type", ], str]):

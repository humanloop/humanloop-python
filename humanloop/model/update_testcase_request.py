...
class UpdateTestcaseRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def inputs() -> typing.Type['UpdateTestcaseRequestInputs']:
                return UpdateTestcaseRequestInputs
            ...
            @staticmethod
            def target() -> typing.Type['UpdateTestcaseRequestTarget']:
                return UpdateTestcaseRequestTarget
            __annotations__ = {
                "inputs": inputs,
                "messages": messages,
                "target": target,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["inputs"]) -> 'UpdateTestcaseRequestInputs': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["messages"]) -> MetaOapg.properties.messages: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["target"]) -> 'UpdateTestcaseRequestTarget': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["inputs"]) -> typing.Union['UpdateTestcaseRequestInputs', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["messages"]) -> typing.Union[MetaOapg.properties.messages, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["target"]) -> typing.Union['UpdateTestcaseRequestTarget', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        inputs: typing.Union['UpdateTestcaseRequestInputs', schemas.Unset] = schemas.unset,
        messages: typing.Union[MetaOapg.properties.messages, list, tuple, schemas.Unset] = schemas.unset,
        target: typing.Union['UpdateTestcaseRequestTarget', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
